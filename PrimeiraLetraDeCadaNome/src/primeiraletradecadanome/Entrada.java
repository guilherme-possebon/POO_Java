...
/**
 * Class Entrada - input class for input of simple input types via simple dialog
 * box. eg. int, char, String, double or boolean.
 *
 * @author Bruce Quig
 ...
 *
 * @version 1.4 Modified (2008.02.25): replaced deprecated "show" method
 *
 * @version 1.3 Modified (2003.08.12): Portuguese version, added methods without
 * parameters.
 */
public class Entrada {
     ...
     *
     ** @param prompt the message string to be displayed inside dialog
     ** @param initialValue input string that is initially displayed as
     ...
     *
     ** @param prompt the message string to be displayed inside dialog
     ** @param initialValue input value that is initially displayed as selected
     * by the user
     ** @return the input character
     *
     */
